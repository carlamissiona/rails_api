...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference("Price.count") do
      post prices_url, params: { price: { description: @price.description, image: @price.image, link: @price.link, name_coin: @price.name_coin, price: @price.price } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { description: @price.description, image: @price.image, link: @price.link, name_coin: @price.name_coin, price: @price.price } }
